...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $sql = $query = "INSERT INTO boosterdose (pname,username, injected,hospitalname,todaydate) VALUES ('$pname','$username','$injected','$hospitalname','$todaydate')";
...
<body class="dbody">
    ...
    <!-- <h1 class="d1"> Congratulation, you'r just one step far from injecting you'r booster dose, please fill this last form.</h1> -->
   <!-- <script>
    alert("Congratulation, you'r just one step far from injecting you'r booster dose, please fill this last form.")
   </script> -->
